...
RUN_NAME=cypherbench-grpo-4 uv run grpo2.py --lora_rank=null --per_device_train_batch_size=2 --gradient_accumulation_steps=64 --num_generations=8 --steps_per_generation=32 --save_steps=25 &
wait $!
